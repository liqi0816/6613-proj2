...
import torch
import numpy as np
from utils.train_test import train_EWC, test_multitask, preprocess_imgs
...
def main(args):
    ...
    ewc = ElasticWeightConsolidation(classifier, crit=criterion, lr=1e-4)
    ...
    for i, train_batch in enumerate(dataset):
        ...
        ewc.register_ewc_params(dataset, args.batch_size, 9)
